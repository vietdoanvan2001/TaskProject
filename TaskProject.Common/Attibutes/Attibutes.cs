...
namespace TaskProject.Common.Attibutes
{
    public class Attibutes
    {
        ...
        /// <summary>
        /// Attribute đánh dấu trường người tạo
        /// </summary>
        public class ModifiedPersonAttribute : ValidationAttribute
        {
            public override bool IsValid(object? value)
            {
                if (value == null)
        ...
        /// <summary>
        /// Attribute đánh dấu trường mật khẩu để mã hóa
        /// </summary>
